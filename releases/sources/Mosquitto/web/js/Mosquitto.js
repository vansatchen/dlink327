function get_Mosquitto_info()
{
	$.ajax({
			...
			async: false,
			cache: false,		
			data: {cmd:"module_Get_One_Info",f_module_name:'Mosquitto'},	
			dataType:"xml",
...
//	    my_url = "http://"+document.domain+":4711?pass=admin";
	...
	if(my_url.indexOf(":")==-1)
	{
	    my_url = "http://"+document.domain+"/Mosquitto/web-client/index.html";
    	window.open(my_url,"Mosquitto");
    }
    else
    {
